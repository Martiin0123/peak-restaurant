...
const galleryImages = [
  {
    id: 1,
    src: "/Gallery1.jpg",
    alt: "PEAK Restaurant Ischgl - Atmospheric dining room with warm ambient lighting and elegant interior design",
    aspect: "aspect-video",
  ...
  },
  {
    id: 2,
    src: "/Gallery2.jpg",
    alt: "PEAK Restaurant - Elegant table setting with premium tableware and scenic view",
    aspect: "aspect-[3/4]",
  ...
  },
  {
    id: 3,
    src: "/Gallery4.jpg",
    alt: "Fresh burrata salad with heirloom tomatoes and basil - Fine dining at PEAK Restaurant Ischgl",
  ...
  },
  {
    id: 4,
    src: "/Gallery5.jpg",
    alt: "Grilled fish fillet with seasonal vegetables - Fine dining at PEAK Restaurant Ischgl",
    aspect: "aspect-video",
    placeholderClass: "bg-[#2A2A2A]",
  },
  {
    id: 5,
    src: "/Gallery6.jpg",
    alt: "Artfully plated burrata appetizer with fresh ingredients - PEAK Restaurant specialty",
    aspect: "aspect-[3/4]",
    placeholderClass: "bg-[#333333]",
  },
  {
    id: 6,
    src: "/Gallery7.jpg",
    alt: "Premium steak being grilled on our Green Egg charcoal grill - PEAK Restaurant Ischgl",
    aspect: "aspect-[3/4]",
  ...
  },
  {
    id: 7,
    src: "/Gallery8.jpg",
    alt: "Beef tartare presentation with capers and onions - PEAK Restaurant Ischgl",
    aspect: "aspect-square",
    placeholderClass: "bg-[#1F1F1F]",
  },
  {
    id: 8,
    src: "/Gallery9.jpg",
    alt: "Fresh seafood cocktail with prawns and garnishes - European cuisine at PEAK",
    aspect: "aspect-[3/4]",
    placeholderClass: "bg-[#2A2A2A]",
  },
  {
    id: 9,
    src: "/Gallery10.jpg",
    alt: "PEAK Restaurant interior - Modern Austrian restaurant design in Ischgl ski resort",
    aspect: "aspect-video",
    placeholderClass: "bg-[#333333]",
  },
];
