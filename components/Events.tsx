            ...
            <div className="lg:px-20 md:px-20 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-6">
                <div className="flex items-center gap-4 mb-6">
                  <h3 className="text-4xl md:text-5xl font-bold group-hover:text-taupe transition-colors duration-300">
                ...
                <p className="text-white/70 text-lg leading-relaxed max-w-xl border-l-2 border-white/10 pl-6 group-hover:border-taupe transition-colors">
                  {language === "de"
                    ? "Zartes Fleisch, fein aromatisierte Brühe und ausgewählte Beilagen. Genussvolle Geselligkeit garantiert."
              ...
              <div className="lg:col-span-3 flex justify-start lg:justify-end">
                <div className="relative w-24 h-24 rounded-full border border-white/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-500 bg-white/5 group-hover:bg-taupe group-hover:border-taupe">
                  <ArrowRight
                    size={32}
